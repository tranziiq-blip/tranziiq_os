...
export default function WeighbillCaptureDialog({ open, onOpenChange, load, 
type, onSaved }) {
 if (!load) return null;
 return (
 ...
 {type === "loaded" ? "Capture Loaded Weighbill" : "Capture Offloaded  Weighbill"}
 </DialogTitle>
 </DialogHeader>
 ...
 <WeighbillUpload load={load} type={type || "offloaded"} onSaved={onSaved} />
 </DialogContent>
 </Dialog>
 );
}
