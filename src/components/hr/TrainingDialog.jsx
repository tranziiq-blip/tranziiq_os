  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>Training Requirement</DialogTitle>
        </DialogHeader>
        <div className="grid grid-cols-2 gap-3 py-1">
          ...
          <F label="Training Type">
            <Select
              value={form.training_type}
              onValueChange={(v) => set("training_type", v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <F label="Status">
            <Select value={form.status} onValueChange={(v) => set("status", v)}>
              ...
              <SelectContent>
                {Object.entries(TRAINING_STATUS).map(([k, s]) => (
          ...
          <F label="Cert Expiry">
            <Input
              ...
              onChange={(e) => set("certification_expiry", e.target.value)}
            />
          </F>
          <F label="Description" full>
            <Textarea
              ...
              rows={2}
              placeholder="Training  description / scope…"
            />
          </F>
          <F label="Notes" full>
            <Input
