    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-1">
          ...
          <p className="text-xs font-semibold uppercase tracking-wider  text-muted-foreground border-t border-border/40 pt-3">
            Employment
          </p>
          <div className="grid grid-cols-2 gap-3">
            <F label="Job Title">
              <Select
                ...
                onValueChange={(v) => set("job_title", v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <F label="Status">
              ...
              >
                ...
                <SelectContent>
                  {Object.entries(EMPLOYEE_STATUS).map(([k, s]) => (
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <F label="Relationship">
              <Input
                ...
                onChange={(e) =>
                  set("next_of_kin_relationship", e.target.value)
                }
              />
            </F>
            <F label="Phone">
          ...
          <F label="Qualifications & Skills" full>
            <Textarea
              value={form.qualifications}
              onChange={(e) => set("qualifications", e.target.value)}
              rows={2}
              placeholder="List qualifications, certifications, skills…"
            />
          </F>
        </div>
        <DialogFooter>
