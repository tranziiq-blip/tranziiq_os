...
import { Home, ClipboardCheck, Package, Fuel, AlertTriangle, ChevronLeft } 
from "lucide-react";
...
export default function DriverLayout() {
 ...
 <button onClick={() => navigate("/")} className="rounded-md p-1.5  text-muted-foreground hover:bg-muted">
 <ChevronLeft size={20} />
 </button>
