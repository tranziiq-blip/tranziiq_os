...
export default function DocumentUploadDialog({ open, onOpenChange, onSaved }) {
  ...
  const save = async () => {
    ...
    try {
      ...
      await base44.entities.SafetyDocument.create({
        ...form,
        file_url,
        status: "active",
      });
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>Upload Policy / SOP</DialogTitle>
        </DialogHeader>
          ...
          <div className="col-span-2">
            <Field label="Document Name *">
              <Input
                ...
                placeholder="e.g. Forklift Safety Policy"
              />
            </Field>
          </div>
          <Field label="Type">
            ...
            >
              ...
              <SelectContent>
                {Object.entries(DOCUMENT_TYPES).map(([k, t]) => (
