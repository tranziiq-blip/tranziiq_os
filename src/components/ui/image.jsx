...
const ImageWrapper = React.forwardRef(({ aspectRatio, className, style, 
children }, ref) => (
 <span
 ref={ref}
...
const ResponsiveImage = React.forwardRef(
 ({ parsed, fittingType, focalPoint, quality, className, style, aspectRatio, 
onLoad, ...props }, parentRef) => {
 ...
 // first paint.
 return (
 <ImageWrapper ref={wrapperRef} aspectRatio={aspectRatio} 
 ...
 * container per device pixel ratio and re-encoded to WebP; 
`fittingType="fill"`
...
const Image = React.forwardRef(
 ...
 const parsedSource = src && src !== FALLBACK_IMAGE_URL ? 
parseWixMediaUrl(src) : null
 const initialMode = parsedSource ? IMAGE_LOAD_MODE.OPTIMIZED : 
IMAGE_LOAD_MODE.ORIGINAL
 ...
 return <img ref={ref} src={FALLBACK_IMAGE_URL} {...imageProps} 
data-empty-image />
 }
 ...
 const imageSrc = isErrorMode ? FALLBACK_IMAGE_URL : getOriginalImageUrl(src, 
parsedSource)
 return (
 <img ref={ref} src={imageSrc} {...imageProps} data-error-image={isErrorMode 
|| undefined} />
 )
 }
