...
export const fleetTypeMeta = (key) =>
  FLEET_TYPES.find((f) => f.key === key) || {
    label: key,
...
export const COMBINATION_TYPES = [
  {
    ...
    axles: [
      { id: "steer", label: "Steer Axle", positions: ["Left", "Right"] },
      {
        id: "drive",
        label: "Drive Axle",
        positions: ["Outer Left", "Inner Left", "Inner Right", "Outer Right"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    axles: [
      ...
      {
        id: "link_1a",
        label: "Trailer 1 — Axle 1",
        positions: ["Left", "Right"],
      },
      {
        id: "link_1b",
        label: "Trailer 1 — Axle 2",
        positions: ["Left", "Right"],
      },
      {
        id: "link_2a",
        label: "Trailer 2 — Axle 1",
        positions: ["Left", "Right"],
      },
      {
        id: "link_2b",
        label: "Trailer 2 — Axle 2",
        positions: ["Left", "Right"],
      },
      {
        id: "link_2c",
        label: "Trailer 2 — Axle 3",
        positions: ["Left", "Right"],
      },
    ],
  },
...
export const combinationMeta = (key) =>
  COMBINATION_TYPES.find((c) => c.key === key) || COMBINATION_TYPES[1];
...
export const LOAD_STATUSES = [
  ...
  {
    key: "enroute_to_loading",
    label: "Enroute to Loading",
    color: "bg-slate-100 text-slate-700",
  },
  {
    key: "arrived_at_loading",
  ...
  {
    key: "weighing_in_empty",
    label: "Weighing In (Empty)",
    color: "bg-cyan-100  text-cyan-700",
  },
  { key: "loading", label: "Loading", color: "bg-indigo-100 text-indigo-700" },
  {
    key: "weighing_out_loaded",
    label: "Weighing Out (Loaded)",
    color: "bg-cyan-100 text-cyan-700",
  },
  {
    key: "enroute_to_offloading",
    label: "Enroute to Offloading",
    color: "bg-slate-100 text-slate-700",
  },
  {
    key: "arrived_at_offloading",
    label: "Arrived at Offloading",
    color: "bg-blue-100 text-blue-700",
  },
  {
    key: "queue_to_offload",
    label: "Queue to Offload",
    color: "bg-amber-100  text-amber-700",
  },
  {
    key: "weighing_in_loaded",
    label: "Weighing In (Loaded)",
    color: "bg-cyan-100 text-cyan-700",
  },
  {
    key: "offloading",
  ...
  {
    key: "weighing_out_empty",
    label: "Weighing Out (Empty)",
    color: "bg-cyan-100 text-cyan-700",
  },
  {
    key: "load_completed",
...
export const loadStatusMeta = (key) =>
  LOAD_STATUSES.find((s) => s.key === key) || {
    label: key,
...
export const trailerTypeMeta = (key) =>
  TRAILER_TYPES.find((t) => t.key === key) || {
    label: key,
    color: "bg-muted text-muted-foreground border-border",
  };
...
export const diffTypeMeta = (key) =>
  DIFF_TYPES.find((d) => d.key === key) || { label: key };
...
export const tyreTypeMeta = (key) =>
  TYRE_TYPES.find((t) => t.key === key) || { label: key };
...
export const expiryStatus = (dateStr) => {
  ...
  if (days < 0)
    return { label: "Expired", color: "bg-rose-100 text-rose-700", days };
  if (days <= 30)
    return {
      label: `${days}d left`,
      color: "bg-amber-100  text-amber-700",
