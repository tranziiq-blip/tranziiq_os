...
export const JOB_ROLES = ["Driver", "Mechanic", "Storekeeper", "Forklift  Operator", "Safety Officer", "Fleet Manager", "Dispatcher", "Administrator", 
"Workshop Supervisor"];

export const RISK_CATEGORIES = [
 { key: "safety", label: "Safety", color: "bg-rose-100 text-rose-700" },
 { key: "health", label: "Health", color: "bg-amber-100 text-amber-700" },
 { key: "environment", label: "Environment", color: "bg-emerald-100  text-emerald-700" },
 { key: "quality", label: "Quality", color: "bg-blue-100 text-blue-700" },
 { key: "operational", label: "Operational", color: "bg-violet-100  text-violet-700" }
];
...
export const VFL_TYPES = {
 ...
 unsafe_condition: { label: "Unsafe Condition", color: "bg-amber-100  text-amber-700" }
};
