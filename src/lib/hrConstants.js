export const DEPARTMENTS = ["Production", "Engineering", "Transport", "SHEQ", 
"Stores", "HR", "Finance", "Admin"];

export const JOB_TITLES = ["Driver", "Mechanic", "Storekeeper", "Forklift  Operator", "Safety Officer", "Fleet Manager", "Dispatcher", "Administrator", 
"Workshop Supervisor", "Operations Manager", "Finance Clerk", "HR Manager", 
"General Worker", "Workshop Foreman", "Controller"];
...
export const EMP_DOC_TYPES = {
 ...
 job_description: { label: "Job Description", color: "bg-brand-teal  text-white" },
 certificate: { label: "Certificate", color: "bg-amber-100 text-amber-700" },
 qualification: { label: "Qualification", color: "bg-emerald-100  text-emerald-700" },
...
export const DISCIPLINARY_TYPES = {
 verbal_warning: { label: "Verbal Warning", color: "bg-amber-100  text-amber-700" },
 written_warning: { label: "Written Warning", color: "bg-orange-100  text-orange-700" },
 ...
 enquiry: { label: "Disciplinary Enquiry", color: "bg-violet-100  text-violet-700" }
};
...
export const PROVINCES = ["Eastern Cape", "Free State", "Gauteng", 
