export const TRUCK_SERVICE_SECTIONS = [
 ...
 {
 id: "transmission", title: "Transmission & Driveline",
 items: [
 ...
 {
 id: "steering", title: "Steering & Suspension",
 items: [
 ...
 {
 id: "cooling", title: "Cooling System",
 items: [
...
export const TRAILER_SERVICE_SECTIONS = [
 ...
 {
 id: "lights", title: "Lights & Electrical",
 items: [
...
export const TECHNICIAN_INSPECTION_SECTIONS = [
 {
 id: "ti_docs", title: "Documentation & Diagnostics",
 items: [
 { id: "ti_odometer", label: "Odometer recorded & checked against service  schedule" },
 { id: "ti_service_history", label: "Service history & previous job cards  verified" },
 { id: "ti_fault_codes", label: "Full diagnostic scan — fault codes recorded &  cleared" },
 { id: "ti_dash_lights", label: "Dashboard warning lights — functional & no  active faults" },
 { id: "ti_oil_sample", label: "Engine oil sample drawn for analysis" },
 { id: "ti_campaigns", label: "Outstanding OEM recalls / campaigns checked" }
 ]
 },
 {
 id: "ti_engine", title: "Engine & Engine Bay",
 items: [
 ...
 { id: "ti_eng_air_filter", label: "Air filter element & restriction  indicator" },
 { id: "ti_eng_fuel_filter", label: "Fuel filters / water separator drained" },
 { id: "ti_eng_turbo", label: "Turbo — shaft play, boost pipes & oil feed  lines" },
 ...
 {
 id: "ti_cooling", title: "Cooling System",
 items: [
 ...
 {
 id: "ti_driveline", title: "Clutch, Gearbox & Driveline",
 items: [
 ...
 {
 id: "ti_brakes", title: "Brakes — All Axles",
 items: [
 { id: "ti_br_pad_front", label: "Front pad thickness measured (mm)" },
 { id: "ti_br_pad_rear", label: "Rear pad / shoe thickness measured (mm)" },
 ...
 { id: "ti_br_leak_test", label: "Leak-down test — service & park applied" },
 ...
 { id: "ti_br_compressor", label: "Compressor & governor cut-out pressure" },
 { id: "ti_br_park", label: "Park brake holding test" }
 ]
 },
 {
 id: "ti_air", title: "Air System",
 items: [
 { id: "ti_air_dryer", label: "Air dryer cartridge & purge valve" },
 { id: "ti_air_gladhand", label: "Glad hands & coiled hoses — wear & seals" },
 { id: "ti_air_coils", label: "Air coil leaks & routing" },
 { id: "ti_air_ppv", label: "Pressure protection valves" }
 ]
 },
 {
 id: "ti_steering", title: "Steering & Suspension",
 items: [
 ...
 {
 id: "ti_electrical", title: "Electrical",
 items: [
 { id: "ti_el_battery", label: "Batteries — load test, hold-down & terminals" 
},
 { id: "ti_el_alternator", label: "Alternator output voltage (13.8–14.4V)" },
 ...
 {
 id: "ti_cab", title: "Cab, Chassis & Coupling",
 items: [
 ...
 {
 id: "tyres", title: "Tyres & Wheels (per position)",
 items: [
 ...
 { id: "ti_ty_mismatch", label: "Twin matching & mismatch across positions" },
 { id: "ti_ty_nuts", label: "Wheel nut torque to spec & indicators aligned" },
...
const withTyrePositions = (sections, tyrePositions) => {
 ...
 return sections.map((s) => s.id !== "tyres" ? s : {
 ...s,
 items: [
 ...s.items.filter((it) => !AGGREGATE_TYRE_IDS.includes(it.id)),
 ...tyrePositions.map((p, i) => ({ id: `ty_pos_${i}`, label: `Tyre — ${p}: 
pressure, tread & damage`, isTyre: true }))
 ]
 });
};

export const getEngineeringChecklist = (assetType, jobType, tyrePositions) => {
 const base = assetType === "trailer"
 ? TRAILER_SERVICE_SECTIONS
 : (jobType === "inspection" ? TECHNICIAN_INSPECTION_SECTIONS : 
...
export const JOB_CARD_STATUS = {
 ...
 parts_ordered: { label: "Parts Ordered", color: "bg-violet-100  text-violet-700" },
